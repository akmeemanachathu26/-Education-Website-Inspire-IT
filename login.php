    ...
    <div class="container-scroller " >
      <div class="container-fluid page-body-wrapper full-page-wrapper" >
        <div class="content-wrapper d-flex align-items-center auth hero">
          ...
          <h1 class="font-weight-semi-bold text-uppercase mb-4  text-center" style="color: #b3d929;;">LOGIN HERE</h1>

            <div class="col-lg-5 mx-auto">
              <div class="auth-form-light text-left p-5">
             
                <h4 class="text-center">Hello! let's get started</h4>
                <h6 class="text-center font-weight-light">Sign in to continue.</h6>
                ...
                <form class="">
                  ...
                  <div class="mt-3">
                    <a style="background-color:#b3d929;color:#ffff;" class="btn btn-block  btn-lg " href="../../index.html">SIGN IN</a>
                  </div>
